            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title">Создать общее название</h3>
                    </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="box-body">
                                    <div class="form-group" style="width: 400px;">
                                        <label for="generic_name">Общее название</label>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Список общих названий</h3>
                    </div>
                    <div class="panel-body">
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Общее название</th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a style="margin: 5px;" class="btn btn-danger"
                                                href="<?php echo base_url(); ?>Delete/generic_name/<?php echo $single_value->generic_id; ?>">Удалить
                                            </a>
                                        </td>
                                    </tr>
                                    <?php } ?>
