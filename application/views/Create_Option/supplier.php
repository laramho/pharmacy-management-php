            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading main-color-bg">
                        <h3 class="panel-title">Создать поставщика</h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group" style="width: 400px;">
                                        <label for="contact_no">Контактный номер</label>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Список поставщиков</h3>
                    </div>
                    <div class="panel-body">
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Название поставщика</th>
                                        <th style="text-align: center;">Контактный номер</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($all_value as $single_value) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php echo $single_value->contact_no; ?></td>
                                            <td style="text-align: center;">
                                                <a style="margin: 5px;" class="btn btn-danger"
                                                    href="<?php echo base_url(); ?>Delete/supplier/<?php echo $single_value->supplier_id; ?>">Удалить
                                                </a>
                                            </td>
                                        </tr>
                                    <?php } ?>
