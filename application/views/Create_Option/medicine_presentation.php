...
<!--						<span class="fa fa-tasks" aria-hidden="true"></span> Категория Продукта</a>-->
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading main-color-bg">
						<h3 class="panel-title">Создать Презентацию Лекарства</h3>
					</div>
							...
							<div class="col-md-3">
								...
								<div class="box-body">
									...
									<div class="form-group" style="width: 400px;">
										<label for="medicine_presentation">Презентация Лекарства</label>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Список Презентаций Лекарств</h3>
					</div>
					<div class="panel-body">
						<div class="panel-body">
							<table class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<th style="text-align: center;">Презентация Лекарства</th>
									...
									<tr>
										...
										<td style="text-align: center;">
											<a style="margin: 5px;" class="btn btn-danger"
											   href="<?php echo base_url(); ?>Delete/medicine_presentation/<?php echo $single_value->record_id; ?>">Удалить
											</a>
										</td>
									</tr>
								<?php } ?>
