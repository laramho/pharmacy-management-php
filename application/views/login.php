      ...
      <div class="container">
        <div class="col-md-10">
          <h1 class="text-center">
            ...
            Вход для администратора <small>Аптечная информационная система</small>
          </h1>
        </div>
      </div>
    </header>
       ...
       <div class="row">
           <div class="col-md-4 col-md-offset-4">
             <form method="post" class="well" action="<?php echo base_url();?>main/login_validation">
                ...
                <a href="<?php echo base_url(); ?>staff/login" class="btn btn-default">Вход для персонала</a>
             </form>
           </div>
       </div>
    </section>
