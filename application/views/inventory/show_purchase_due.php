<div class="box-body table-responsive" style="width: 100%; color: black;">
	<div class="row">
		<div class="form-group col-sm-3 col-xs-12">
			<label for="old_due">Предыдущая задолженность</label>
		...
		<div class="form-group col-sm-3 col-xs-12">
			<label for="final_due">Окончательная задолженность</label>
		...
		<div class="form-group col-sm-3 col-xs-12">
			<button type="button" class="pull-left btn btn-success" id="pay_btn"
					style="margin-top: 22px; width: 70%;">Оплатить</button>
		</div>
	</div>
	<table id="example2" class="table table-bordered table-hover">
		...
		<tr>
			<th colspan="8">
				<p style="text-align: center; font-weight: bold;">Имя поставщика: <?php echo $supplier_name; ?></p>
			</th>
		</tr>
		<tr>
			...
			<th style="text-align: center;">Задолженность</th>
		</tr>
		</thead>
		<tbody>
		<?php
		...
		<tr>
			<td colspan="8">
				<p style="text-align: center; font-weight: bold;">Общая задолженность: $<?php echo $old_due; ?></p>
			</td>
		</tr>
		</tbody>
	</table>
